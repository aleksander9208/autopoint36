...
{
    $arLinkProducts[] = $ob['VALUE'];
}

if($arLinkProducts):?>
    <section class="s-recomendation">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="section-title"><?=GetMessage('CATALOG_LINK_PRODUCT')?></div>
                </div>
            </div>
                <?
                global $arFilProduct;
                $arFilProduct['ID'] = $arLinkProducts;
                $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'1','BIG_DATA':false},{'VARIANT':'1','BIG_DATA':false}]",
