    ...
    false
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-10">
                    ...
                    <?if($_GET['brand']){
                        ...
                        $property_enums = CIBlockPropertyEnum::GetList(Array("DEF"=>"DESC", "SORT"=>"ASC"), Array("IBLOCK_ID"=> 8, "CODE"=>"PROIZVODITEL", "VALUE" => $_GET['brand']));
                        $enum_fields = $property_enums->GetNext();
                        $arCatalog["PROPERTY"]['PROIZVODITEL']['VALUE_ENUM_ID'] = $enum_fields['ID'];
                    ?>
