...
if ($arParams['SHOW_BASKET_PAGE'] === 'Y')
{
	$availablePages[] = array(
		...
		"icon" => 'icon-shoping-cart-outline'
	);
}
...
<?if (empty($availablePages)):
    ...
    <div class="personal-area">
        <div class="row justify-content-center">
            ...
            <?if($key==3):?><div class="col-12"></div><?endif;?>
                <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="personal-area__item">
                        <a href="<?=htmlspecialcharsbx($blockElement['path'])?>">
                            <div class="personal-area__thumb">
                                <span class="icon"><i class="<?=htmlspecialcharsbx($blockElement['icon'])?>"></i></span>
                            </div>
                            <div class="personal-area__title"><?=htmlspecialcharsbx($blockElement['name'])?></div>
                        </a>
                    </div>
                </div>
            <?endforeach;?>
