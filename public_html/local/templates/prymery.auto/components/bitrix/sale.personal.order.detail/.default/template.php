...
else
{
	...
	<div class="container-fluid sale-order-detail">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container">
							<div class="row">
								<div class="col-md-4 col-sm-6 sale-order-detail-about-order-inner-container-name">
									...
									<a class="def-link sale-order-detail-about-order-inner-container-name-read-less">
										<?= Loc::getMessage('SPOD_LIST_LESS') ?>
									</a>
									<a class="def-link sale-order-detail-about-order-inner-container-name-read-more">
								...
								if ($arParams['GUEST_MODE'] !== 'Y')
								{
									...
									<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
										<a href="<?=$arResult["URL_TO_COPY"]?>" class="adp-btn adp-btn--primary">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container-details">
								...
								{
									?>
                                    <div class="sale-order-detail-about-order-inner-container-list-item">
											...
											<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods">
												<div class="sale-order-detail-payment-options-methods-information-block">
													<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-info">
														...
														{
															?>
															<a href="#" id="<?=$payment['ACCOUNT_NUMBER']?>" class="def-link sale-order-detail-payment-options-methods-info-change-link">
													...
													?>
													<div class="sale-order-detail-payment-inner-row-template col-md-5 col-sm-10 col-xs-12">
														<a class="def-link sale-order-list-cancel-payment">
											...
											<div class="col-md-12 col-md-12 col-sm-12 sale-order-detail-payment-options-shipment-container">
												<div class="row">
													<div class="col-md-12 col-md-12 col-sm-12 sale-order-detail-payment-options-shipment">
                                                        <div class="col-md-1 col-sm-2 col-xs-2 sale-order-detail-payment-options-info-image" style="background-image: url('/bitrix/images/sale/logo-default-d.gif')"></div>


														<div>
															<div class="col-md-11 col-sm-10 sale-order-detail-payment-options-methods-shipment-list">
																...
																<?/*div class="sale-order-detail-payment-options-methods-shipment-list-item-link">
																	<a class="def-link sale-order-detail-show-link">
                                                                        <?= Loc::getMessage('SPOD_LIST_SHOW_ALL')?>
                                                                        <span class="icon">
                                                                            <i class="icon-angle-down"></i>
                                                                        </span>
                                                                    </a>
																	<a class="def-link sale-order-detail-hide-link"><?= Loc::getMessage('SPOD_LIST_LESS')?></a>
																</div*/?>
															</div>
															<?
																											...
																											<div class="sale-order-detail-order-item-block">
																												...
																												<div class="sale-order-detail-order-item-content">
																													<div class="sale-order-detail-order-item-title">
																														<a class="def-link" href="<?=htmlspecialcharsbx($basketItem['DETAIL_PAGE_URL'])?>"><?=htmlspecialcharsbx($basketItem['NAME'])?></a>
																													</div>
																													<?
												...
												<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
													<div class="sale-order-detail-order-item-td" style="min-width: 300px;">
														<div class="sale-order-detail-order-item-block">
															...
															<div class="sale-order-detail-order-item-content">
																<div class="sale-order-detail-order-item-title">
																	<a class="def-link" href="<?=$basketItem['DETAIL_PAGE_URL']?>">
		...
		{
			?>
			<a class="def-link sale-order-detail-back-to-list-link-down" href="<?= $arResult["URL_TO_LIST"] ?>">&larr; <?= Loc::getMessage('SPOD_RETURN_LIST_ORDERS')?></a>
			<?
		}
		?>
	</div>
